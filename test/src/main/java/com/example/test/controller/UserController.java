...
//        }
    ...
    @RequestMapping(value = "/user/new", method = RequestMethod.POST)
    public ResponseEntity<Void> addRole(@RequestBody User user, @PathVariable String userName) {
        System.out.println("Adding role to user" + user.getUserName());

        userRepository.updateEmployee(userName);
